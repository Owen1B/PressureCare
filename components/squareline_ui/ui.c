...
ui_Screen_1_Print1_screen_init();
ui_Screen_2_Move1_screen_init();
ui____initial_actions0 = lv_obj_create(NULL);
lv_disp_load_scr( ui_Screen_1_Print1);
}

void ui_destroy( void )
{ui_Screen_1_Print1_screen_destroy();
ui_Screen_2_Move1_screen_destroy();
}
